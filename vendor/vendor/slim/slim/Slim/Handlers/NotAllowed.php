...
class NotAllowed extends AbstractHandler
{
        ...
        if ($request->getMethod() === 'OPTIONS') {
            ...
            switch ($contentType) {
                ...
                case 'text/html':
                    ...
                    break;
                default:
                    throw new UnexpectedValueException('Não é possível processar o tipo de conteúdo desconhecido ' . $contentType);
            }
        }
    ...
    protected function renderJsonNotAllowedMessage($methods)
    {
        ...
        return '{"message":"Método não permitido. Deve ser um dos: ' . $allow . '"}';
    }
    ...
    protected function renderXmlNotAllowedMessage($methods)
    {
        ...
        return "<root><message>Método não permitido. Deve ser um dos: $allow</message></root>";
    }
...
<html>
    ...
    <body>
        ...
        <p>Método não permitido. Deve ser um dos: <strong>$allow</strong></p>
    </body>
</html>
END;
