...
class EdcaoDAO extends Connection
{
    ...
    {   
        ...
        {   
            ...
            concat_ws('', replace(edcao.ds_edcao_url, 'http://edicao.cbnet.net.br', 'http://edicao.correiobraziliense.com.br'), '/thumb/', pdcao.cd_pdcao, '.jpg') as thumb,
            concat_ws('', replace(edcao.ds_edcao_url, 'http://edicao.cbnet.net.br', 'http://edicao.correiobraziliense.com.br'), '/pdf/', 'axx', lpad(pdcao.vl_pdcao_pagin, 2, '0'), date_format(edcao.dt_edcao, '%d%m'), '.pdf') as pdf,
            concat_ws('', replace(edcao.ds_edcao_url, 'http://edicao.cbnet.net.br', 'http://edicao.correiobraziliense.com.br'), '/issue', pdcao.cd_edcao, '.pdf') as pdf_completo,
            concat_ws('', replace(edcao.ds_edcao_url, 'http://edicao.cbnet.net.br', 'http://edicao.correiobraziliense.com.br'), '/jpgdevice/', pdcao.cd_pdcao, '.jpg') as device,
            concat_ws('', replace(edcao.ds_edcao_url, 'http://edicao.cbnet.net.br', 'http://edicao.correiobraziliense.com.br'), '/jpg/', pdcao.cd_pdcao, '.jpg') as imageAlta,
            concat_ws('', replace(edcao.ds_edcao_url, 'http://edicao.cbnet.net.br', 'http://edicao.correiobraziliense.com.br'), '/thumb/', pdcao.cd_pdcao, '.jpg') as image
            from
            jonal, prded, mstre, edcao,
            (
                select
